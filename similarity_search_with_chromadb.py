...
# use new virtual environment if needed
# conda create -n simsearch python=3.9
# pip install chromadb==1.0.12 OR if using conda, conda install chromadb==1.0.12
# pip install sentence-transformers==4.1.0 OR if using conda, conda install sentence-transformers==4.1.
